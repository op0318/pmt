...
import 'package:pmt_updated/view/pages/projects/updateemployeedetails.dart';
          ...
          children: [
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 120,),Image.asset('assets/images/projectimages/user1.png')]),
                  SizedBox(height: 30,),
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.deepPurple,
                  minimumSize: Size(150, 50)),
                onPressed: (){
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => UpdateEmpdetails(),));
                }, child:
